    ...
    public void eventOccurred(Object source)
    {
        ...
        switch (((Button) source).getId())
        {
            ...
            case "notificationsButton":
                fxmlController.setMainPane(PanesController.getPanesController().getUserslistPane("notifications", MainPageController.getMainPageAgent().getUser().getId(), 0).getListPane());
                BackButtonHandler.getBackButtonHandler().clear();
