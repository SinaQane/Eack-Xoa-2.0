...
import apps.mainpage.pages.viewlist.logic.ListAgent;
...
public class UsersList
{
    ...
    public UsersList(String pageKind, User user)
    {
        ...
        /*
        If the first lines in refresh function worked, delete these:

        ((UsersListFXML) this.loader.getController()).setUser(this.user);
        ((UsersListFXML) this.loader.getController()).setPageKind(this.pageKind);
        */
    }
    ...
    public void refresh(int page)
    {
        ...
        ListAgent logicalAgent = new ListAgent(this.user, this.pageKind);
