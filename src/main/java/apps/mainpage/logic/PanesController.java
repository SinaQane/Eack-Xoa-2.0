...
import apps.mainpage.pages.viewlist.view.UsersListFXML;
import db.UserDB;
...
public class PanesController
{
    ...
    public ProfilePane getProfilePane(int page)
    {
        ...
        ((ProfilePaneFXML) this.profilePane.getLoader().getController()).setProfileListener(new ProfileListener(this.profilePane));
    ...
    public ProfilePane getProfilePane(long id, int page)
    {
        ...
        ((ProfilePaneFXML) userProfilePane.getLoader().getController()).setProfileListener(new ProfileListener(userProfilePane));
    ...
    public UsersList getUserslistPane(String pageKind, long id, int page)
    {
        ...
        ((UsersListFXML) usersList.getLoader().getController()).setListener(new ListListener());
